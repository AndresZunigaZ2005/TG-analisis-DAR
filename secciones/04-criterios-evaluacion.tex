...
\begin{enumerate}[label=\textbf{\arabic*.}, leftmargin=*, itemsep=0.7em, series=criterios]
  \item \textbf{Repositorio local archivos grandes}
  ...
  \item \textbf{Priorización tráfico académico (QoS)}
  ...
  \item \textbf{Métricas uso red y proxy}
  ...
  \item \textbf{Automatización certificados SSL}
...
\begin{enumerate}[resume*=criterios]
  \item \textbf{Tiempos de descarga deficientes}
  ...
  \item \textbf{Uso no misional de red}
  ...
  \item \textbf{Falta certificados SSL firmados}
...
\begin{enumerate}[resume*=criterios]
  \item \textbf{Gobernanza del tráfico}
  ...
  \item \textbf{Optimización ancho de banda}
  ...
  \item \textbf{Toma decisiones basada en datos}
...
\begin{enumerate}[resume*=criterios]
  \item \textbf{Cache archivos grandes}
  ...
  \item \textbf{ACL listas blancas/negras}
  ...
  \item \textbf{Proxy transparente/inverso/estándar}
  ...
  \item \textbf{Gestión certificados digitales}
...
\begin{enumerate}[resume*=criterios]
  \item \textbf{Escalabilidad almacenamiento}
  ...
  \item \textbf{Volúmenes transferencia altos}
  ...
  \item \textbf{Integración servicios existentes}
  ...
  \item \textbf{Monitoreo tiempo real + alta disponibilidad}
...
\begin{enumerate}[resume*=criterios]
  \item \textbf{Consumo ancho de banda por usuario}
  ...
  \item \textbf{Estadísticas tráfico por categoría}
  ...
  \item \textbf{Tiempos de respuesta promedio}
...
\begin{enumerate}[resume*=criterios]
  ...
  \item \textbf{Diferenciar tráfico misional/no misional}
  ...
  \item \textbf{Adaptación a cambios}
