...
% ---------- Contenido ------------------------------------------------
\input{secciones/01-metodologia-evaluacion}
\input{secciones/02-plantilla-evaluacion}
\input{secciones/03-analisis-dar}
\input{secciones/04-criterios-evaluacion}
\input{secciones/05-tecnologia-ganadora}
